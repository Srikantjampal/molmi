...
class Certificate_model extends CI_Model
{
	...
	function add($candidateID, $content)
	{
		...
		if ($this->db->insert('certificate', $this->_data)) {
			...
			if ($data['type'] == 'Others' || $data['type'] == 'DNV-ST0029') {
	...
	function get_certificate_Trainer($id)
	{
	...
	function getAllcertificates($trainerId)
	{
	...
	function getAllCertificatesCandidates($id)
	{
