...
<div data-template-type="html" style="height: auto; padding-bottom: 49px; class="ui-sortable">
<input type="button" id="printBtn" value="Print" onclick="window.print()">
   <!--[if !mso]><!-->
   <!--<![endif]-->
   <table align="center" class="full" border="0" style="border: 1px solid #333; background-image:url(<?php echo $base_url_views;?>images/navy.jpg); background-size:cover; background-position:center;" cellpadding="0" cellspacing="0" data-module="Module-7" data-bgcolor="M7 Bgcolor 1">
                        ...
                        <td>
                           <table width="800" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                              <tbody>
                                 ...
                                 <!-- title -->
                                 <tr>
                                    <td class="res-center selected-element" style="text-align: center; color: #1b1b1b; font-family: 'Playfair Display', serif; font-size: 24px; letter-spacing: 0.7px; font-weight: bold;text-transform: uppercase; word-break: break-word" data-color="M2 Title 1" data-size="M2 Title 1" data-max="32" data-min="12" contenteditable="false">
