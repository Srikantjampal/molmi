					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="theme-form">
								...
								<input type="text" id="certificate_no" name="certificate_no" value="<?php echo $certificate_no; ?>">
							</div>
						</div>
						...
						<div class="col-md-3">
							<div class="theme-form">
								...
								<select id="type" name="type" required>
									<option value="">---</option>
									<option value="DNV / LNV" <?php if($type == 'DNV / LNV'){ echo "selected";} ?>>DNV / LNV</option>
