	...
	<main>
		...
		<div class="container">
			...
			<div class="theme-form-header">
				...
				<h2><a href="<?php echo $base_url;?>topic/lists"><i class="las la-arrow-left"></i></a> Edit Topic</h2>

			</div>

			<div class="form-white-bg">

			<form role="form" id="form" method="post" action="<?php echo $base_url;?>topic/edit/<?php echo $id; ?>" enctype="multipart/form-data" >
