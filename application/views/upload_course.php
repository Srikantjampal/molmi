...
<head>
	...
	<title>Upload Course | MOLMI</title>
	...
	<main>
		...
		<div class="container">
			...
			<div class="theme-form-header">
				...
				<h2><a href="<?php echo $base_url;?>course/lists"><i class="las la-arrow-left"></i></a> Upload course</h2>

			</div>

			<div class="form-white-bg">

			<form role="form" id="form" method="post" action="<?php echo $base_url;?>course/upload" enctype="multipart/form-data">
