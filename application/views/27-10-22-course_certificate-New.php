...
<input type="button" id="printBtn" value="Print" onclick="window.print()">
   <!--[if !mso]><!-->
   <!--<![endif]-->
   <table align="center" class="full" border="0" style="border: 1px solid #333; background-image:url(<?php echo $base_url_views;?>images/navy.jpg); background-size:cover; background-position:center;margin-top:80px;" cellpadding="0" cellspacing="0" data-module="Module-7" data-bgcolor="M7 Bgcolor 1">
                                                ...
                                                <td valign="top">
                                                   ...
                                                   <table style="overflow: hidden; border-radius: 4px;" width="700" align="left" class="res-full" border="0" cellpadding="0" cellspacing="0">
                                                      ...
                                                      <tbody>
                                                         ...
                                                         <tr>
                                                            <td>
                                                               <img width="188" style="width: 100%; display: block; line-height: 0px; font-size: 0px; border: 0px;" src="<?php echo $base_url_views;?>images/image003.png">
                                                            </td>
                                                         </tr>
                                                         <!-- image end -->
                        ...
                        <td>
                           <table width="800" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                              <tbody>
                                 ...
                                 <!-- title -->
                                 <tr>
                                    <td class="res-center selected-element" style="text-align: center; color: #1b1b1b; font-family: 'Playfair Display', serif; font-size: 32px; letter-spacing: 0.7px; font-weight: bold;text-transform: uppercase; word-break: break-word" data-color="M2 Title 1" data-size="M2 Title 1" data-max="32" data-min="12" contenteditable="false">
                            ...
                            <!-- (<?php //echo $detail->course_level; ?> LEVEL) -->
                                 ...
                                 <!-- name -->
                                 <tr>
                                    <td class="res-center selected-element" style="text-align: center; color: #1b1b1b; font-family: 'Playfair Display', serif; font-size: 25px; letter-spacing: 0.7px; word-break: break-word; border-bottom: 1px solid #000; border-bottom: 1px solid #b7b7b7; line-height: 55px;" data-color="M2 Title 1" data-size="M2 Title 1" data-max="32" data-min="12" contenteditable="false">
									<?php echo $detail->caprefix; ?>. <?php echo $detail->candidate_name; ?>
                                    </td>
                                 </tr>
                                 <tr>
                                    <td class="res-center" style="text-align: center; color: #202020; font-family: 'Playfair Display', serif; font-size: 18px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M2 Paragraph 1" data-size="M2 Paragraph 1">
                                       Name and Last Name
                                    </td>
                                 </tr>
                                 <!-- name end -->
                        ...
                        <td>
                           <table width="600" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                              <tbody>
                                 ...
                                 <tr>
                                    <td class="res-center" style="text-align: center; color: #202020; font-family: 'Playfair Display', serif; font-size: 17px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M2 Paragraph 1" data-size="M2 Paragraph 1" data-max="26" data-min="6">
                                       Date Of Birth
                                    </td>
                                 </tr>
                                 <!-- name end -->
                                                ...
                                                <table style="overflow: hidden; border-radius: 4px;" width="300" align="left" class="res-full" border="0" cellpadding="0" cellspacing="0">
                                                   ...
                                                   <tbody>
                                                      <tr>
                                                         ...
                                                         <td class="res-center selected-element" style="text-align: center; color: #1b1b1b; font-family: 'Playfair Display', serif; font-size: 18px; letter-spacing: 0.7px; word-break: break-word;font-weight: 600;" data-color="M2 Title 1" data-size="M2 Title 1" data-max="32" data-min="12" contenteditable="false">
                     ...
                     <td>
                        <table width="600" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                           <tbody>
                              ...
                              <!-- paragraph -->
                              <tr>
                                 <td class="res-center" style="text-align: center; color: #181818; font-family: 'Playfair Display', serif; font-size: 18px; letter-spacing: 0.4px; font-weight:600; line-height: 23px; word-break: break-word" data-color="M7 Paragraph 1" data-size="M7 Paragraph 1" data-max="26" data-min="6">
                     ...
                     <td>
                        <table width="800" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                           <tbody>
                                          ...
                                          <tr>
                                             ...
                                             <td>
                                                <table align="center" border="0" cellpadding="0" cellspacing="0">
                                                   ...
                                                   <tbody>
                                                      <tr>
                                                         <td class="res-center" style="text-align: left; color: #383838; font-family: 'Playfair Display', serif; font-size: 19px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word; font-weight: 600;" data-color="M19 Paragraph 1" data-size="M19 Paragraph 1" data-max="26" data-min="6">
                              ...
                              <!-- paragraph -->
                              <tr>
                                 <td class="res-center" style="text-align: left; color: #202020; font-family: 'Playfair Display', serif; font-size: 18px; letter-spacing: 0.4px; height: 470px;vertical-align: baseline; word-break: break-word;" data-color="M19 Paragraph 3" data-size="M19 Paragraph 3" data-max="26" data-min="6">
                                                                                          ...
                                                                                          <tr>
                                                                                             <td>
                                                                                                <table align="center" border="0" cellpadding="0" cellspacing="0">
                                                                                                   <tbody>
                                                                                                      <tr>
                                                                                                         <td style="text-align: left; color: #202020; font-family: 'Playfair Display', serif; font-size: 17px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word">
                                                                                                            Certificate No. :
                                                                                                         </td>
                                                                                                      </tr>
                                                                                                   </tbody>
                                             ...
                                             <td valign="top">
                                                ...
                                                <table width="290" align="right" class="res-full" border="0" cellpadding="0" cellspacing="0">
                                                   ...
                                                   <tbody>
                                                      ...
                                                      <!-- paragraph -->
                                                      <tr>
                                                         <td class="res-center" style="text-align: right; color: #202020; font-family: 'Playfair Display', serif; font-size: 16px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M20 Paragraph 1" data-size="M20 Paragraph 1" data-max="26" data-min="6">
                                                      ...
                                                      <!-- link -->
                                                      <tr>
                                                         <td class="res-center" style="text-align: right; color: #202020; font-family: 'Playfair Display', serif; font-size: 16px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word">
                        ...
                        <table width="900" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <tr>
                                    <td class="res-center" style="text-align: center; color: #202020; font-family: 'Playfair Display', serif; font-size: 18px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M2 Paragraph 1" data-size="M2 Paragraph 1" data-max="26" data-min="6">
                                       (Course Faculty)
                                    </td>
                                 </tr>
                                 <!-- name end -->
                     ...
                     <td>
                        <table width="600" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                           <tbody>
                              <!-- paragraph -->
                              <tr>
                                 <td class="res-center" style="text-align: center; color: #202020; font-family: 'Playfair Display', serif; font-size: 16px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M19 Paragraph 3" data-size="M19 Paragraph 3" data-max="26" data-min="6">
                              ...
                              <tr>
                                 <td class="res-center" style="text-align: center; color: #202020; font-family: 'Playfair Display', serif; font-size: 12px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M19 Paragraph 3" data-size="M19 Paragraph 3" data-max="26" data-min="6">
