...
<div data-template-type="html" style="height: auto; padding-bottom: 30px;padding-top: 0px;" class="ui-sortable">
<input type="button" id="printBtn" value="Print" onclick="window.print()">
                                                      ...
                                                      <tbody>
                                                         ...
                                                         <tr>
                                                            ...
                                                            <?php
                                                               ...
                                                               $google_chart_api_url = "https://quickchart.io/qr?text=".$string1."&size=150";
                                                               echo "<img src='".$google_chart_api_url."' alt='".$string1."'>";
                                                               ?>
            ...
            <td>
               <table width="1000" align="center" class="margin-full ui-resizable" border="0" cellpadding="0" cellspacing="0" data-bgcolor="M2 Bgcolor 2">
                  <tbody>
                     <tr>
                        <td>
                           <table width="950" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                              <tbody>
                                 <tr>
                            ...
                            <!-- (<?php //echo $detail->course_level; ?> LEVEL) -->
                                 ...
                                 <tr>
									...
									<?php echo $detail->caprefix; ?><?php if($detail->caprefix != ''){echo ".";} ?> <?php echo $detail->candidate_name; ?>
                                    </td>
                                 </tr>
                                 <tr>
   ...
   <table align="center" class="full" border="0" cellpadding="0" cellspacing="0" data-thumbnail="http://www.stampready.net/dashboard/editor/user_uploads/zip_uploads/2020/03/22/9jhlVUzudcB8NtbnMg67SvA5/StampReady/thumbnails/thumb-4.png" data-module="Module-4" data-bgcolor="M4 Bgcolor 1">
      <tbody>
         <tr>
            <td>
               <table width="850" align="center" class="margin-full ui-resizable" border="0" cellpadding="0" cellspacing="0" data-bgcolor="M4 Bgcolor 2">
                  <tbody>
                     <tr>
                        <td>
                     ...
                     <td>
                        <table width="900" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                           <tbody>
                              ...
                              <tr>
                                 <td>
                                    <table class="full" width="900" align="center" border="0" cellpadding="0" cellspacing="0">
                                       <tbody>
                                          <tr>
                                             <td valign="top">
                                                <!-- left column -->
                        ...
                        <table width="900" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <tr>
                                    <td class="res-center selected-element" style="text-align: center;text-transform: uppercase; color: #1b1b1b; font-family: 'Jost', sans-serif; font-size: 18px; letter-spacing: 0.7px; word-break: break-word; border-bottom: 1px solid #000; border-bottom: 1px solid #b7b7b7; line-height: 40px; font-weight: 600;" data-color="M2 Title 1" data-size="M2 Title 1" data-max="32" data-min="12" contenteditable="false">
									<?php echo $detail->tprefix; ?><?php if($detail->tprefix != ''){echo ".";} ?> <?php echo $detail->trainer_name; ?>
                                    </td>
                                 </tr>
                                 <tr>
                                                   ...
                                                   <tbody>
                                                      ...
                                                      <?php if($detail->show_logo == 1){ ?>
                                                         <?php if($detail->type == 'DNV-ST0029'){ ?>
                                                            <td ><img src="<?php echo $base_url_views;?>images/DNV-ST0029.png" ></td>
                                                         <?php } else{ ?>
         ...
         <td>
            <table style="border-radius: 0 0 6px 6px;" width="750" align="center" class="margin-full ui-resizable" border="0" cellpadding="0" cellspacing="0" data-bgcolor="M19 Bgcolor 2">
               <tbody>
                  <tr>
                     <td>
                        <table width="700" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                           <tbody>
                              <!-- paragraph -->
                              <tr>
                                  ...
                                  <!--NEW ENTRY STARTS -->
                                  <td>
                                    <img src="https://certificate.molmi.info/betas/application/views/images/GlobalMET-Logo.jpg" style="font-family: 'Playfair Display', serif !important;width: 200px;vertical-align: middle;border: 0; margin-left:-97px;">
                                  </td>
                                  <!--NEW ENTRY ENDS-->
                                  
                                  
                                 <td class="res-center" style="text-align: center;text-transform: uppercase; color: #202020; font-family: 'Jost', sans-serif; font-size: 12px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M19 Paragraph 3" data-size="M19 Paragraph 3" data-max="26" data-min="6">
