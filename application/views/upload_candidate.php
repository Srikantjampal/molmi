...
<head>
	...
	<title>Upload Candidate | MOLMI</title>
	...
	<main>
		...
		<div class="container">
			...
			<div class="theme-form-header">
				...
				<h2><a href="<?php echo $base_url;?>candidate/lists"><i class="las la-arrow-left"></i></a> Upload Candidate</h2>

			</div>

			<div class="form-white-bg">

			<form role="form" id="form" method="post" action="<?php echo $base_url;?>candidate/upload" enctype="multipart/form-data">
         		<INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
				<INPUT TYPE="hidden" NAME="action" VALUE="upload_candidate">
