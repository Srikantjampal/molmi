                        ...
                        <td>
                           <table width="800" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <!-- (<?php //echo $detail->course_level; ?> LEVEL) -->
                                 ...
                                 <tr>
                                    <td class="res-center" style="text-align: center; color: #202020; font-family: 'Jost', sans-serif; font-size: 18px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M2 Paragraph 1" data-size="M2 Paragraph 1">
                                       Name and Last Name
                                    </td>
                                 </tr>
                                 <!-- name end -->
                        ...
                        <td>
                           <table width="600" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                              <tbody>
                                 ...
                                 <tr>
                                    <td class="res-center" style="text-align: center; color: #202020; font-family: 'Jost', sans-serif; font-size: 17px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M2 Paragraph 1" data-size="M2 Paragraph 1" data-max="26" data-min="6">
                                       Date Of Birth
                                    </td>
                                 </tr>
                                 <!-- name end -->
                                                ...
                                                <table style="overflow: hidden; border-radius: 4px;" width="300" align="left" class="res-full" border="0" cellpadding="0" cellspacing="0">
                                                   ...
                                                   <tbody>
                                                      <tr>
                                                         ...
                                                         <td class="res-center selected-element" style="text-align: center; color: #1b1b1b; font-family: 'Jost', sans-serif; font-size: 18px; letter-spacing: 0.7px; word-break: break-word;font-weight: 600;" data-color="M2 Title 1" data-size="M2 Title 1" data-max="32" data-min="12" contenteditable="false">
                     ...
                     <td>
                        <table width="600" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                           <tbody>
                              ...
                              <!-- paragraph -->
                              <tr>
                                 <td class="res-center" style="text-align: center; color: #181818; font-family: 'Jost', sans-serif; font-size: 18px; letter-spacing: 0.4px; font-weight:600; line-height: 23px; word-break: break-word" data-color="M7 Paragraph 1" data-size="M7 Paragraph 1" data-max="26" data-min="6">
                     ...
                     <td>
                        <table width="800" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                           <tbody>
                                          ...
                                          <tr>
                                             ...
                                             <td>
                                                <table align="center" border="0" cellpadding="0" cellspacing="0">
                                                   ...
                                                   <tbody>
                                                      <tr>
                                                         <td class="res-center" style="text-align: left; color: #383838; font-family: 'Jost', sans-serif; font-size: 19px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word; font-weight: 600;" data-color="M19 Paragraph 1" data-size="M19 Paragraph 1" data-max="26" data-min="6">
                              ...
                              <!-- paragraph -->
                              <tr>
                                 <td class="res-center" style="text-align: left; color: #202020; font-family: 'Jost', sans-serif; font-size: 18px; letter-spacing: 0.4px; height: 470px;vertical-align: baseline; word-break: break-word;" data-color="M19 Paragraph 3" data-size="M19 Paragraph 3" data-max="26" data-min="6">
                                                                                          ...
                                                                                          <tr>
                                                                                             <td>
                                                                                                <table align="center" border="0" cellpadding="0" cellspacing="0">
                                                                                                   <tbody>
                                                                                                      <tr>
                                                                                                         <td style="text-align: left; color: #202020; font-family: 'Jost', sans-serif; font-size: 17px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word">
                                                                                                            Certificate No. :
                                                                                                         </td>
                                                                                                      </tr>
                                                                                                   </tbody>
                                             ...
                                             <td valign="top">
                                                ...
                                                <table width="290" align="right" class="res-full" border="0" cellpadding="0" cellspacing="0">
                                                   ...
                                                   <tbody>
                                                      ...
                                                      <!-- paragraph -->
                                                      <tr>
                                                         <td class="res-center" style="text-align: right; color: #202020; font-family: 'Jost', sans-serif; font-size: 16px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M20 Paragraph 1" data-size="M20 Paragraph 1" data-max="26" data-min="6">
                                                      ...
                                                      <!-- link -->
                                                      <tr>
                                                         <td class="res-center" style="text-align: right; color: #202020; font-family: 'Jost', sans-serif; font-size: 16px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word">
                        ...
                        <table width="900" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <tr>
                                    <td class="res-center" style="text-align: center; color: #202020; font-family: 'Jost', sans-serif; font-size: 18px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M2 Paragraph 1" data-size="M2 Paragraph 1" data-max="26" data-min="6">
                                       (Course Faculty)
                                    </td>
                                 </tr>
                                 <!-- name end -->
                     ...
                     <td>
                        <table width="600" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                           <tbody>
                              <!-- paragraph -->
                              <tr>
                                 <td class="res-center" style="text-align: center; color: #202020; font-family: 'Jost', sans-serif; font-size: 16px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M19 Paragraph 3" data-size="M19 Paragraph 3" data-max="26" data-min="6">
                              ...
                              <tr>
                                 <td class="res-center" style="text-align: center; color: #202020; font-family: 'Jost', sans-serif; font-size: 12px; letter-spacing: 0.4px; line-height: 23px; word-break: break-word" data-color="M19 Paragraph 3" data-size="M19 Paragraph 3" data-max="26" data-min="6">
